...
public class NewsReader {
    ...
    public void start(Context context) {
        ...
        this.mNewsArrayList.add(createNews("Massa fustigó con dureza a sus rivales directos",
                ...
                "Rodeado por sus economistas y con un discurso que priorizó la promesa de eliminar el impuesto a las ganancias, recuperar las jubilaciones y reactivar las economías regionales, Sergio Massa desembarcó ayer en Neuquén para presentar las metas de gobierno del frente UNA. Pero, ante la consulta de los medios locales, se salió de ese libreto y disparó contra sus rivales: identificó a Mauricio Macri con el regreso a los 90 y puso en duda la capacidad de liderazgo de Daniel Scioli frente a la influencia de Cristina Kirchner.\n\"El cambio que propone Mauricio Macri es una invitación al pasado. Es el ajuste\", apuntó el tigrense, que vinculó al candidato de Cambiemos con el ex ministro de Economía Domingo Cavallo. \"Nosotros lo que les planteamos a los argentinos es que hay tres países en juego: el país de Roberto Lavagna, el país de Axel Kicillof y el país de Domingo Cavallo\", señaló.\nAsí, Massa retomó el repertorio de críticas que destinaba a Macri antes de que estallara el escándalo de las millonarias contrataciones de la Ciudad con Fernando Niembro y la posterior renuncia del candidato a diputado de Cambiemos. Fue, quizá, por la reunión que días atrás mantuvieron el líder de Pro y el gobernador de Córdoba, José Manuel de la Sota, donde hablaron de \"bajar el tono\" a los cruces verbales entre macristas y massistas. O, tal vez, por el peso creciente de la agenda económica en la campaña.\nAnte la consulta por el debate de candidatos el tigrense volvió a pedir que la Presidenta \"autorice\" a Scioli a presentarse a la cita. Pero fue más allá y puso en duda el liderazgo del bonaerense si le toca llegar a la presidencia. \"¿Dónde va a estar la Casa Rosada el 11 de diciembre si sigue gobernando el Frente para la Victoria? No puede haber dos jefes, el doble comando te lleva a los fracasos\", alertó, en diálogo con radio La Red. Se amparó en los dichos de los dirigentes kirchneristas que plantearon un eventual gobierno de Scioli como la \"transición\" para el regreso, en 2019, de Cristina Kirchner.\nComo sucederá hoy en Córdoba, cuando vuelva a mostrarse junto a De la Sota y el economista Roberto Lavagna, Massa presentó ayer sus metas de gobierno. Fue en el Museo Nacional de Bellas Artes de Neuquén, a donde acudió junto a los economistas Aldo Pignanelli y Ricardo Delgado, y el diputado y ex titular de la UIA, José Ignacio de Mendiguren. Como anfitrión se movió el senador Guillermo Pereyra, secretario adjunto de la CGT opositora y líder de los trabajadores petroleros y del gas privado de Neuquén, Río Negro y La Pampa.\nCon esos socios, el discurso de Massa apuntó a la economía. Prometió eliminar el impuesto a las ganancias a los trabajadores y las trabas a la producción local. \"No podemos quedarnos de brazos cruzados mientras vemos cómo las manzanas se pudren arriba de los árboles, los productores se funden y se disuelven miles de empresas familiares. Los impuestos, el costo del flete, la caída de los precios internacionales amenazan cientos de miles de fuentes de trabajo\", afirmó.\nTambién insistió en que los 500.000 millones de pesos del fondo de sustentabilidad de la Anses -y la rentabilidad que genera- permiten pagar el 82% móvil a los jubilados y los juicios adeudados por el Estado. \"Es una vergüenza que en la Argentina un preso gane más que un jubilado\", concluyó.\nLos economistas no sólo presentaron las metas ajustadas a las necesidades de la región. También se metieron en la disputa política con el macrismo. \"Creo que hoy la propuesta del Frente Renovador es muy clara. Ya se sabe que está Lavagna o De la Sota y todavía el PRO no muestra sus actores. Nos gustaría saber si [el ministro de Economía] es Melconian o Sturzenegger\", chicaneó De Mendiguren.\n\"Vamos a mantener el diferencial entre el precio interno y el internacional del petróleo, para favorecer las nuevas inversiones y generar más empleo en el sector. Nuestra propuesta de infraestructura generará inversiones en gas y petróleo del orden de los 20.000 millones de dólares anuales\", prometió Delgado, que dentro del equipo de Massa se especializó en elaborar el plan de infraestructura y energía.", Category.POLITICA, "http://bucket2.glanacion.com/anexos/fotos/21/2096921w300.jpg"));
        ...
        this.mNewsArrayList.add(createNews("Kicillof analiza un canje para el Boden 2015, pero teme que no sea aceptado en el exterior",
                ...
                "\n" +
                        "\"Nos están pidiendo desesperadamente eso [por un canje], porque la gente que invierte en la Argentina, que tiene ese bono, quiere seguir teniendo bonos. Entonces nos lo están pidiendo. Vamos a ver las condiciones y la situación, porque con las medidas financieras conviene no generar expectativas\", sostuvo Kicillof en declaraciones radiales.\n" +
                        "Pero la operación no sería sencilla. Al menos, según confiaron a LA NACION ejecutivos de fondos del exterior, el Gobierno ya estuvo en los últimos días sondeando sin demasiado éxito a través de bancos extranjeros el apetito de los grandes inversores internacionales por un canje de bonos.\n" +
                        ...
                        "\"La intención del canje está -aseguró a LA NACION un hombre cercano al ministro Kicillof-. Hay que ver si las tasas del mercado lo permiten.\"\n" +
                        "Así las cosas, será difícil para Economía evitar que el pago de Boden ponga presión a las reservas del Banco Central. Amilcar Collante, economista del Centro de Estudios Económicos del Sur, estima que de los US$ 33.301 millones de reservas informadas por el BCRA, unos US$ 11.000 millones ya corresponden al préstamo acordado con China, cuyo primer tramo empieza a vencer en octubre. A su vez, dice, habría otros US$ 8200 millones que son en realidad depósitos de terceros que están en el sistema financiero. Con lo cual, las reservas disponibles sumarían US$ 14.000 millones y todo sin contemplar la deuda de US$ 8100 millones del BCRA con importadores.\n" +
                        "Kicillof, no obstante, refutó ayer las versiones de que el Gobierno podría pesificar los pagos del Boden. \"Nadie en el mercado , nadie en su sano juicio tiene la menor duda de que se va a pagar el Boden 2015\", dijo.\n" +
                        "El BCRA, por su parte, aprovechó en los últimos meses para comprar Boden 15 y así neutralizar el impacto de parte de los pagos. Fuentes que siguen de cerca el movimiento de la entidad, aseveran que habría logrado hacerse de bonos por poco más de US$ 400 millones.\n" +
                        "La consultora Ecolatina calcula que la totalidad del vencimiento de Boden son US$ 6525 millones (el 40% de las reservas disponibles), que se suman a otros US$ 675 millones que se deben pagar en la misma semana por un bono de la provincia de Buenos Aires.\n" +
                        "\"", Category.ECONOMIA, "http://bucket2.glanacion.com/anexos/fotos/31/2096931w225tlnhan.jpg"));
    ...
    private News createNews(String title, String subtitle, String contenido, Category category, String uri) {
        News news = new News();
        news.title = title;
