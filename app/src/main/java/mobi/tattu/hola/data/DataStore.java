...
/**
 * Created by leandrog on 12/11/14.
 */
public class DataStore {
    ...
    private DataStore() {
        mCtx = HolaLaNacionApplication.getContext();
    }
     ...
     * @param key
     */
    public <T> void putAll(Collection<T> objects, Class<T> type,Object key) {
        ...
        for (T object : objects) {
            ...
            root.add(DATA, getParser().toJsonTree(object));
            root.addProperty(TIMESTAMP, System.currentTimeMillis());
            editor.putString(resolveKey(key), root.toString());
        }
    ...
    public void putObject(Object key, Object object) {
        ...
        prefs.edit().putString(resolveKey(key), root.toString()).commit();
    }
